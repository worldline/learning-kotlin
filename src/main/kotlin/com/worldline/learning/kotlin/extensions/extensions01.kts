...
// TODO overload fun 'attack():String' with the extension fun 'Adventurer.attack(damage: Int):String' that prints the value passed as a parameter

// TODO print the results of this new extension function with parameter values 50, 10 and 200

// TODO in the following code, what is the result of printStatus on a Barbarian ? what do you conclude ?
