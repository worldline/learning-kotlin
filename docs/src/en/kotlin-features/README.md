...
We define this extension with a function literal with receiver as follows. 
...
[**Type-safe builders**](https://kotlinlang.org/docs/type-safe-builders.htmlhttps://kotlinlang.org/docs/type-safe-builders.html) combine well-named builder functions and functions with literal receiver to create type-safe, statically typed builders in Kotlin.

::: tip Builder pattern
[The builder pattern]() is a way to construct complex objects.

```kotlin
// StirngBuilder use the builder pattern
...
[Kotlin docs](https://kotlinlang.org/docs/type-safe-builders.html) provide an example of an advanced type-safe builder.
